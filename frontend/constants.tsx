...
// Layout constants for consistent sizing and styling
export const LAYOUT = {
  SIDEBAR_WIDTH: 'w-64',
  CARD: 'bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-xl hover:shadow-blue-500/5 hover:border-blue-200 transition-all duration-300',
};

// Intentional Design System constants
export const THEME = {
  RADIUS: '24px',
  SHADOW: '0 4px 6px -1px rgb(0 0 0 / 0.05), 0 2px 4px -2px rgb(0 0 0 / 0.05)',
  SHADOW_LG: '0 20px 25px -5px rgb(0 0 0 / 0.05), 0 8px 10px -6px rgb(0 0 0 / 0.05)',
};
...
// Icons tailored for GST360 branding and finance
export const ICONS = {
  Logo360: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M21 3v5h-5" />
      <text x="5" y="15" fontSize="6" fontWeight="900" fill="currentColor" stroke="none" fontFamily="Inter">GST</text>
    </svg>
  ),
  Shield: (props: any) => (
